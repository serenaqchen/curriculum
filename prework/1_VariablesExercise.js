...
// num2 but not num1?
// The difference between num1 rules and num2 rules is that the range for num1 is exclusive, 
// while the range for num2 is inclusive 
// Values that is valid for num2 but not num1 is 1 and 10 
...
// I thought that this exercise was fairly easy. Did not really use any references.
